...
{
public:
    explicit Account(const std::string& name, int balance) : data_(std::make_shared<Tracked>(name)), balance_(balance)
    {
    }
...
{
public:
    explicit Resource(const std::string& name) : data_(std::make_shared<Tracked>(name))
    {
    }
...
{
public:
    explicit Container(const std::string& name) : data_(std::make_shared<Tracked>(name))
    {
    }
...
{
public:
    HierarchicalResource(const std::string& name, int level) : data_(std::make_shared<Tracked>(name)), level_(level)
    {
    }
