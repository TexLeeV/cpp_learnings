...
TEST_F(AlignmentCacheFriendlyTest, FalseSharing)
{
    ...
    EXPECT_EQ(offsetof(SharedCacheLine, counter2) - offsetof(SharedCacheLine, counter1), sizeof(int));
    ...
    EXPECT_EQ(offsetof(SeparateCacheLines, counter2) - offsetof(SeparateCacheLines, counter1), 64);
