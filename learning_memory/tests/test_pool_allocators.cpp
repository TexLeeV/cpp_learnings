...
public:
    ...
    : next_free_(0)
    {
        ...
        EventLog::instance().record("FixedSizePool::ctor (pool_size=" + 
    ...
    T* allocate()
    {
        ...
        for (size_t i = 0; i < PoolSize; ++i)
        {
            if (free_list_[i])
            {
                ...
                EventLog::instance().record("FixedSizePool::allocate slot " + 
                                           std::to_string(i));
    ...
    void deallocate(T* ptr)
    {
        ...
        EventLog::instance().record("FixedSizePool::deallocate slot " + 
                                    std::to_string(slot));
    }
