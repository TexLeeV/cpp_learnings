...
{
    {
        ...
        // Q: What is the difference between the deleter stored in the control block and the default deleter used by
        // make_shared?
        // A:
        // R:
...
{
    {
        std::shared_ptr<Tracked> p1(new Tracked[3]{Tracked("D1"), Tracked("D2"), Tracked("D3")},
...
TEST_F(DeallocationLifetimeTest, AliasingConstructorLifetime)
{
...

    {
        ...
        // Q: Which deleter will be invoked when the last reference is released, the one for Container or the one for
        // Tracked?
        // A:
        // R:
